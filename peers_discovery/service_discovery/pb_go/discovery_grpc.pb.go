...
type PeerDiscoveryClient interface {
	...
	GetPeer(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Peer, error)
	GetPeers(ctx context.Context, in *Session, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Peer], error)
...
func (c *peerDiscoveryClient) GetPeer(ctx context.Context, in *Session, opts ...grpc.CallOption) (*Peer, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Peer)
...
func (c *peerDiscoveryClient) GetPeers(ctx context.Context, in *Session, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Peer], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &PeerDiscovery_ServiceDesc.Streams[1], PeerDiscovery_GetPeers_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[Session, Peer]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type PeerDiscoveryServer interface {
	...
	GetPeer(context.Context, *Session) (*Peer, error)
	GetPeers(*Session, grpc.ServerStreamingServer[Peer]) error
...
func (UnimplementedPeerDiscoveryServer) GetPeer(context.Context, *Session) (*Peer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPeer not implemented")
}
func (UnimplementedPeerDiscoveryServer) GetPeers(*Session, grpc.ServerStreamingServer[Peer]) error {
...
func _PeerDiscovery_GetPeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerDiscoveryServer).GetPeer(ctx, req.(*Session))
	}
...
func _PeerDiscovery_GetPeers_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PeerDiscoveryServer).GetPeers(m, &grpc.GenericServerStream[Session, Peer]{ServerStream: stream})
}
